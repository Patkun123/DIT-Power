<div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav class="shadow-xl px-4 py-2.5 bg-gradient-to-r from-emerald-400 via-emerald-600 to-emerald-950 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
          ...
          <form action="#" method="GET" class="hidden md:block md:pl-2">
            ...
            <div class="relative md:w-96">
              ...
              <input
                ...
                name="email"
                id="topbar-search"
                class="bg-emerald-100 border border-primary-300 text-primary-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </form>
        ...
        <div class="flex items-center lg:order-2">
          ...
          <!-- Dropdown menu -->
          <div
            class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-sm bg-gradient-to-r from-emerald-400 via-emerald-600 to-emerald-950"
            id="dropdown"
          >
            <div class="py-3 px-4">
              <span
