        ...
        <div class="bg-gray-100 dark:bg-gray-900 shadow-md shadow-lime-600 rounded-lg p-5">
                ...
                <div class="flex items-center gap-4">
                   <div class="w-12 h-12 rounded-full overflow-hidden flex items-center justify-center bg-green-600 text-white text-lg font-bold">
                        <?php if($user->profileimage): ?>
                            <img src="<?php echo e(asset('storage/' . $user->profileimage)); ?>"
                                alt="<?php echo e($user->firstname ??  'Not'); ?> <?php echo e($user->lastname ?? 'Registered'); ?>"
                    ...
                    <div>
                        <h2 class="text-lg font-semibold"><?php echo e($user->firstname ??  'Not'); ?> <?php echo e($user->lastname ?? 'Registered'); ?></h2>
            ...
            <div class="grid grid-cols-2 gap-4 my-5 text-center">
                <div class="flex flex-col items-center cursor-pointer transition-all hover:-translate-y-1 rounded-xl bg-gray-200 dark:bg-gray-800 hover:shadow-2xl p-5 hover:bg-lime-300 shadow shadow-lime-500">
                    ...
                    <p class="text-xl font-semibold"><?php echo e($user->journals_count); ?></p>
                ...
                <div class="flex flex-col items-center cursor-pointer transition-all hover:-translate-y-1 rounded-xl bg-gray-200 dark:bg-gray-800 hover:shadow-2xl p-5 hover:bg-lime-300 shadow shadow-lime-500">
                    ...
                    <p class="text-xl font-semibold"><?php echo e($user->quiz_attempts_sum_score ?? 0); ?></p>
            ...
            <p class="text-sm text-gray-500 flex items-center">
                ...
                <span class="ml-1 font-medium">
                    <?php echo e($user->last_active_at ? $user->last_active_at->diffForHumans() : 'Never'); ?>
...
<?php echo $__env->make('auth.admin.partials.layouts.app.head', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\systems\DIT-Power\DTI-Power\resources\views/auth/admin/view/user-tracking.blade.php ENDPATH**/ ?>