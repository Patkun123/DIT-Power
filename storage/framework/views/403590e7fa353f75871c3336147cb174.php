<div wire:poll.1s="tick" class="flex flex-col items-center  bg-gray-50 dark:bg-gray-800 transition-all hover:shadow-xl hover:-translate-y-1 shadow-primary-500  rounded-xl shadow p-6">
    ...
    <h1 class="text-4xl font-bold mb-5">
        <?php echo e(gmdate('i:s', (int) $this->timeRemaining)); ?>
    ...
    <audio id="timer-audio" src="<?php echo e(asset('sounds/start.mp3')); ?>" preload="auto"></audio>
</div>
...
<?php /**PATH C:\xampp\htdocs\systems\DIT-Power\resources\views/livewire/countdown-timer.blade.php ENDPATH**/ ?>