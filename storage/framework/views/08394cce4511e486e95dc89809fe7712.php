    ...
    <!-- Trigger Button -->
                ...
                <div id="userDropdown" class="hidden z-50 absolute right-0 mt-2 w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="userMenuButton">
                        <li>
                            <a href="<?php echo e(Route('settings.profile')); ?>" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Account Settings</a>
                        </li>
                    </ul>
                    <div class="py-2">
                ...
                <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-white bg-primary-700 hover:bg-white hover:text-primary-500 transition-all duration-300 hover:shadow-lg shadow-primary-500/50 hover:-translate-y-0.5 focus:ring-4 hover:ring-1 hover:ring-primary-500 focus:ring-primary-600 font-medium rounded-full text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-gray-800 focus:outline-none dark:focus:ring-primary-800">Get Started</a>
            <?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['xData' => true,'xOn:click' => '$flux.dark = ! $flux.dark','icon' => 'moon','variant' => 'subtle','ariaLabel' => 'Toggle dark mode']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => true,'x-on:click' => '$flux.dark = ! $flux.dark','icon' => 'moon','variant' => 'subtle','aria-label' => 'Toggle dark mode']); ?>
            ...
            <div class="hidden  justify-between items-center w-full bg-gray-50 dark:bg-gray-800 shadow-2xl shadow-accent-foreground rounded-2xl lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row bg-white dark:bg-gray-800 lg:space-x-7 lg:mt-0">
                    <li>
                            ...
                            class="<?php if(request()->routeIs('index')): ?>
                        ...
                        <li>
                        <a href="<?php echo e(route('journal')); ?>"
                            class="<?php if(request()->routeIs('journal')): ?>
                                flex items-center gap-2 text-primary-700 font-semibold dark:text-lime-500 bg-primary-200 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php else: ?>
                                flex items-center gap-2 text-gray-800 lg:bg-white dark:text-white lg:text-primary-700 dark:text-white dark:text-lime-500 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php endif; ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('nutrition')); ?>"
                            class="<?php if(request()->routeIs('nutrition')): ?>
                                flex items-center gap-2 text-primary-700 font-semibold dark:text-lime-500 bg-primary-200 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php else: ?>
                                flex items-center gap-2 text-gray-800 lg:bg-white dark:text-white lg:text-primary-700 dark:text-white dark:text-lime-500 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php endif; ?>">
                        ...
                        <li>
                            ...
                            class="<?php if(request()->routeIs('quiz')): ?>
                                flex items-center gap-2 text-primary-700 font-semibold dark:text-lime-500 bg-primary-200 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php else: ?>
                                flex items-center gap-2 text-gray-800 lg:bg-white dark:text-white lg:text-primary-700 dark:text-white dark:text-lime-500 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php endif; ?>">
                        ...
                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex cursor-pointer items-center gap-2 py-2 pr-4 pl-3 text-gray-900 rounded dark:bg-gray-800 lg:text-primary-700 lg:p-0 dark:text-white">
                            <svg class="w-[30px] h-[30px] text-current" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="<?php echo e(route('policies')); ?>"
                            class="<?php if(request()->routeIs('policies')): ?>
                                flex items-center gap-2 text-primary-700 font-semibold dark:text-lime-500 bg-primary-200 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php else: ?>
                                flex items-center gap-2 text-gray-800 lg:bg-white dark:text-white lg:text-primary-700 dark:text-white dark:text-lime-500 p-2 lg:bg-white lg:dark:bg-gray-800 lg:p-0
                            <?php endif; ?>">
                ...
                <!-- Dropdown menu -->
                        <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="<?php echo e(route('physical.tools')); ?>" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Physical Tools</a>
                                </li>
                                <li>
...
<?php /**PATH C:\xampp\htdocs\systems\DIT-Power\DTI-Power\resources\views/auth/users/partials/header.blade.php ENDPATH**/ ?>