<div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav class="shadow-xl px-4 py-2.5 bg-gradient-to-l from-lime-300 via-lime-600 to-lime-900 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center justify-between mr-4">
        <!-- Mobile Logo -->
        <img
        ...
        <div class="flex items-center lg:order-2">
          ...
          >
            ...
            <img src="<?php echo e(auth()->user()->profileimage
          ...
          >
            <div class="py-3 px-4">
              <span
                ...
                ><?php echo e(auth()->user()->firstname); ?></span
              >
              <span
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::menu.item','data' => ['as' => 'button','type' => 'submit','icon' => 'arrow-right-start-on-rectangle','class' => 'w-full hover:bg-gray-600 rounded-none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['as' => 'button','type' => 'submit','icon' => 'arrow-right-start-on-rectangle','class' => 'w-full hover:bg-gray-600 rounded-none']); ?>
...
<?php /**PATH C:\xampp\htdocs\systems\DIT-Power\DTI-Power\resources\views/auth/admin/partials/layouts/side.blade.php ENDPATH**/ ?>