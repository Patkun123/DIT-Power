            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form method="GET" action="<?php echo e(route('manage.user')); ?>" class="flex items-center">
                        <?php echo csrf_field(); ?>
...
<form method="GET" action="<?php echo e(route('manage.user')); ?>" class="relative inline-block">
...
<ul class="space-y-2 text-sm text-gray-700 dark:text-gray-200">
    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class="flex items-center">
            <input type="checkbox"
                   name="departments[]"
                   id="dept-<?php echo e($value); ?>"
                   ...
                   <?php echo e(in_array($value, request('departments', [])) ? 'checked' : ''); ?>>
            <label for="dept-<?php echo e($value); ?>" class="ml-2"><?php echo e($label); ?></label>
        </li>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-4 flex justify-between">
            ...
            <a href="<?php echo e(route('manage.user')); ?>" class="text-sm text-gray-500 hover:underline">Reset</a>
        </div>
    </div>
</form>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <?php echo e($user->firstname ?? 'N/A'); ?>&nbsp;<?php echo e($user->lastname ?? ''); ?>

                                </th>
                                <td class="px-4 py-3"><?php echo e($user->email); ?></td>
                                <td class="px-4 py-3"><?php echo e($user->staff->office ?? 'N/A'); ?></td>
                                <td class="px-4 py-3"><?php echo e($user->staff->staff_id ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="dropdown-button-<?php echo e($index); ?>" data-dropdown-toggle="dropdown-<?php echo e($index); ?>" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-<?php echo e($index); ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
...
<?php /**PATH C:\xampp\htdocs\systems\DIT-Power\DTI-Power\resources\views/auth/admin/partials/layouts/app/tables/user-table.blade.php ENDPATH**/ ?>