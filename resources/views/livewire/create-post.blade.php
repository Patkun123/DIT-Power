...
<<<<<<< HEAD
        <button wire:click="openModal" 
                type="button"
                class="flex-1 px-4 py-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full cursor-pointer transition-colors text-left">
            <p class="text-gray-500 dark:text-gray-400 text-sm">What's on your mind, {{ auth()->user()->firstname }}?</p>
=======
...
>>>>>>> Rooffce
    ...
    <div class="flex items-center justify-around pt-3 border-t border-gray-200 dark:border-gray-700">
        <button wire:click="openModal"
                type="button"
                class="flex items-center justify-center space-x-2 py-2 px-4 flex-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
    ...
    <div wire:click="closeModal"
        ...
        <div wire:click.stop
            ...
            {{-- Modal Header --}}
            <div class="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-center relative">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Create Post</h3>
                <button wire:click="closeModal"
                        type="button"
                        class="absolute right-4 w-10 h-10 flex items-center justify-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors">
            ...
            {{-- Modal Body --}}
            <form wire:submit.prevent="createPost" class="flex flex-col flex-1 min-h-0">
                <div class="flex-1 overflow-y-auto p-4">
                    ...
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-1 text-xs">
                                <select class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 border-0 rounded px-2 py-0.5 text-xs">
                    ...
                    <div class="relative mb-4">
                        <textarea wire:model="content"
                                  ...
                                  wire:keydown.escape="hideMentionSuggestions"
                                  placeholder="What's on your mind, {{ auth()->user()->firstname }}?"
                                  class="w-full px-0 py-2 bg-transparent border-0 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-0 resize-none text-lg"
                                  rows="6"
                        ...
                        {{-- Mention Suggestions --}}
                        @if($showMentionSuggestions && $currentMentionField === 'post')
                            <div class="mention-suggestions absolute left-0 right-0 top-full mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-xl max-h-56 overflow-y-auto z-10">
                    ...
                    @if($showImagePreview && $image)
                        <div class="mb-4 relative rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                            <img src="{{ $image->temporaryUrl() }}"
                                 alt="Preview"
                                 class="w-full max-h-96 object-contain bg-gray-50 dark:bg-gray-900">
                            <button type="button"
                                    wire:click="removeImage"
    ...
    @if (session()->has('message'))
        <div class="mt-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 rounded-lg">
            {{ session('message') }}
        </div>
    @endif
...
<<<<<<< HEAD
    @if (session()->has('error'))
        <div class="mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg">
            {{ session('error') }}
=======
