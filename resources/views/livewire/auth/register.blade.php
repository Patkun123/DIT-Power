        ...
        <div class="dark:bg-gray-900 bg-gray-100 p-6 space-y-10">
            ...
            <form wire:submit.prevent="{{ $step === 4 ? 'register' : 'nextStep' }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <flux:select wire:model="level_career" :label="__('Select Career Level')" required>
                    ...
                    <flux:input wire:model.defer="nature_of_work" icon="briefcase" :label="__('Nature of Work')" placeholder="Enter nature of work" required />
                    <flux:input wire:model.defer="function" icon="cog" :label="__('Function')" placeholder="Enter function" required />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <flux:select wire:model="educational_attachment_type" :label="__('Educational Attachment Type')" required>
                        <flux:select.option>Bachelor's Degree</flux:select.option>
                        <flux:select.option>Master's Degree</flux:select.option>
                        <flux:select.option>Doctorate</flux:select.option>
                        <flux:select.option>Certificate</flux:select.option>
                        <flux:select.option>Diploma</flux:select.option>
                    </flux:select>
                    <flux:input wire:model.defer="educational_attachment" icon="academic-cap" :label="__('Educational Attachment')" placeholder="Enter educational attachment" required />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <flux:input type="number" icon="circle-stack" wire:model.defer="height" :label="__('Height')" placeholder="152 (cm)" />
                    <flux:input wire:model.defer="weight" icon="circle-stack" :label="__('Weight (kg)')" placeholder="52 (kg)" />
