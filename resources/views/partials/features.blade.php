<section class="bg-gray-100 dark:bg-gray-900" id="features">
      ...
      <div class="inline-block relative mb-6">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
          Get help for the following topics
            ...
            <span class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 h-1 w-90 bg-primary-500 dark:bg-primary-400 rounded"></span>
      </div>
...
<div class="grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-8">
          <div>
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Physical Well-being</h3>
              <p class="text-gray-500 dark:text-gray-400">Our team is committed to promoting physical well-being through guided fitness programs, health education, and personalized support.</p>
          </div>
          <div>
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Financial Well-being</h3>
              <p class="text-gray-500 dark:text-gray-400">Experienced professionals providing personalized guidance, educational resources, and tools to support your financial well-being and long-term financial goals.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
