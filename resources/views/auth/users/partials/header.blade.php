                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <li>
                                    <a href="{{route('mental.tools')}}"
                                        class="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors group
                                              @if(request()->routeIs('mental.tools') || request()->routeIs('emotional.tools'))
                                                  bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400
                                              @else
                                                  text-gray-700 dark:text-gray-300
                                              @endif">
                                        ...
                                        <span class="font-medium">Mental & Emotional Well-Being</span>
                                    </a>
                                </li>
                                <li>
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <div class="space-y-1">
                ...
                <div id="mobile-dd-tools" class="ml-9 space-y-1 {{ (request()->routeIs('physical.tools') || request()->routeIs('mental.tools') || request()->routeIs('emotional.tools') || request()->routeIs('financial.tools') || request()->routeIs('nutrition')) ? '' : 'hidden' }}">
                    ...
                    <a href="{{ route('mental.tools') }}" class="block p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors {{ (request()->routeIs('mental.tools') || request()->routeIs('emotional.tools')) ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300' : 'text-gray-600 dark:text-gray-400' }}">
