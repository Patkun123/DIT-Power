  <div class="flex justify-between items-start w-full">
      <div class="flex-col items-center">
        <div class="flex items-center mb-1">
            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Users by Age</h5>
...
<script>
const pieOptions = {
  series: @json(($ageCounts ?? collect())->values()),
  labels: @json(($ageLabels ?? collect())->values()),
  chart: {
    type: 'pie',
    height: 360,
