...
<div class="h-70 md:h-80 w-full bg-gradient-to-l from-primary-400 via-primary-600 to-lime-700">
    <div class="container mx-auto flex items-start justify-start h-full px-2 md:px-70">
        <div class="flex flex-col mt-40 md:mt-40">
            <h1 class="text-2xl md:text-4xl text-white">Edit <b>Event</b></h1>
            <span class="text-white text-sm md:text-base mt-2">Update event details</span>
        </div>
    </div>
</div>
                ...
                <div class="mb-6">
                    ...
                    @if($event->image_url)
                        <div class="mb-4">
                            ...
                            <img src="{{ $event->image_url }}" alt="{{ $event->title }}" class="h-32 w-auto rounded-lg">
                        </div>
                    @endif
