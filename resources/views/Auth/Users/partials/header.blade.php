    ...
    <nav class=" h-20 px-0 lg:px-10 dark:bg-gray-800">
        <div class="flex flex-wrap  justify-between mt-1 lg:py-2 py-2 items-center mx-auto max-w-screen-1xl">
            ...
            @endif
                ...
                <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-xs text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
            ...
            <div class="hidden  justify-between items-center w-full bg-gray-50 dark:bg-gray-800 shadow-2xl shadow-accent-foreground rounded-2xl lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row bg-white dark:bg-gray-800 lg:space-x-5 xl:space-x-10 lg:mt-0">
                    <li>
                            <a href="{{ route('index') }}"
